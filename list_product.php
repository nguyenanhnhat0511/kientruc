                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <?php 
                          $sql = "SELECT * FROM phone where id_brands=$id limit 8";
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="product-detail.php?id=<?= $row['id']; ?>&name=<?= $row['name'];?>"><img src="img/man/polo-shirt-2.png" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn" href="http://localhost:8081/bai4/rest/services/themgiohang/<?= $_SESSION['id'] ?>/<?= $row['id']; ?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              ...
                              <?php if($row['sale'] != 0){ ?>
                              <span class="aa-product-price"><?= number_format($row["sale"]) ?></span>
                              <?php 
                            }
                            ?>
                              <span class="aa-product-price"><del><?= number_format($row["price"]) ?></del></span>
                            </figcaption>
                          </figure>                        
                       ...
                       <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn" href="http://localhost:8081/bai4/rest/services/themgiohang/<?= $_SESSION['id'] ?>/<?= $row['id']; ?>"><span class="fa fa-shopping-cart"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
